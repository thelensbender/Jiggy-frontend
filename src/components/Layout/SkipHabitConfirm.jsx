...
export default function SkipHabitConfirm({setShowSkipConfirm}) {
   ...
   const buttonInfo = [
      ...
      },
      {
         ...
         textColour: "white",
         onClick: ()=> {
            notify("Skipped for today", "success");
            navigate("/habit")
         }
      }
   ]
    ...
    <div className=' z-50 inset-0 fixed  flex flex-col justify-center items-center w-screen h-screen backdrop-blur-md'>
      ...
      <div className='flex backdrop-blur-md flex-col justify-center items-center max-w-2/7 p-10 bg-white rounded-3xl shadow'>
         ...
         <div className='flex flex-col items-center'>
            ...
            <div className='bg-[#ffddb7] py-1.5 px-5 border border-[#ffd3a0] rounded-full font-bold mt-4'>🔥"5-day" streak at risk</div>
         </div>
         <div className='text-wrap text-center text-[#5b5665] text-lg mt-6'>
            You're about to skip <span className='text-[#8B5CF6]  font-bold'>"Drink 8 glasses of water"</span>for today. Skipping will <strong>break</strong> your current streak. Are you sure?
         </div>
