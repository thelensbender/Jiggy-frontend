...
export default function HabitCard({habit, setShowConfirm, setSelectedHabit}) {
   ...
   return (
      <div className={`relative rounded-md flex items-center justify-between ${habitName.length < 8 ? "gap-25" : "gap-10"} md:gap-50 bg-[#fffdff] py-5 px-3 md:px-5 group transition-all duration-200 hover:shadow-xl`}>
